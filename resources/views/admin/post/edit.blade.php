                        ...
                        <form action="{{route('admin.post.update')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-4 d-flex align-content-around justify-content-center flex-wrap">
                                    <img id="imgpreview" src="{{asset($post['thumbnail'])}}" alt="" width="auto" height="150">
                                    <div class="">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col">
                                            <input type="text" class="form-control" name="meta_title"
                                                placeholder="Enter meta title" value="{{$post['meta_title']}}" required/>
                                            @error('meta_title')
                                                <span class="text-danger">{{$message}}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col">
                                            <textarea name="meta_description" class="form-control" rows="3" placeholder="Enter Meta Description" required>{{$post['meta_description']}}</textarea>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col">
                                            <textarea name="meta_keywords" class="form-control" rows="2" placeholder="Enter Meta Keyword" required>{{$post['meta_keywords']}}</textarea>
                                            @error('meta_keywords')
                                                <span class="text-danger">{{$message}}</span>
                                            @enderror
                                        </div>
                            ...
                            <div class="row mt-3 g-2">
                                <h6>Detail</h6>
                                <textarea name="detail" class="form-control" required>{{$post['detail']}}</textarea>
                                @error('detail')
                                    <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
